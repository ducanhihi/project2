...
@section('content')
            ...
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td class="fw-bold">{{$products-> quantity}}</td>
    ...
    <div id="addEmployeeModal" class="modal fade" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/admin/create/products" method="POST">
                    @csrf
    ...
    <div id="editEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="/admin/edit/products/{{$products -> id}}">
                    @csrf
                    <div class="modal-header">
                     ...
                     <div class="modal-body">
                        <div class="form-group">
                            <label>ISBNcode</label>
                            <input type="text" name="isbn_code" class="form-control" required="" value="{{$products -> isbn_code}}">
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                        ...
                        <div class="form-group">
                            <label>Quantity</label>
                            <input type="text" name="quantity" class="form-control" required="" value="{{$products -> quantity}}">
                        </div>
                        <div class="form-group">
                            <label>Price</label>
                        ...
                        <div class="form-group">
                            <label>CategoryId</label>
                            <input type="text" name="category_id" class="form-control" required="" value="{{$products -> category_id}}">
                        </div>
                        <div class="form-group">
                            <label>BrandId</label>
                            <input type="text" name="brand_id" class="form-control" required="" value="{{$products -> brand_id}}">
                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
    ...
    <div id="deleteEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/home/products/{{$products-> id}}" method="POST">
                    @method('DELETE')
                    @csrf
                    <div class="modal-header">
